...
class BotVlwTest extends TestCase
{
    ...
    private $robotYxg = 'wxid_7gih532dnq7f22';
    ...
    public function __construct() {
        parent::__construct();
        $this->bot = new Vlw(['app_key' => 'quNhWFeMrTcsjPnUIUtcpZHMHcAsEDRq', 'base_uri' => '124.222.4.168:8090']);
    }
     ...
     * Author: fudaoji<fdj@kuryun.cn>
     */
    public function testGetDetailByWxid() {
        $res = $this->bot->getDetailInfoByWxid([
            'robot_wxid' => $this->robotYxg,
            'to_wxid' => $this->robotYxg,
        ]);
        dump($res);
    ...
    public function testGetFriendList() {
        ...
        foreach ($res['ReturnJson'] as $v){
            if($v['wxid'] == $this->robotYxg){
                dump($v);
            }
        }
        //dump($res);
