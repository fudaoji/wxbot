...
class Setting extends Base
{
    ...
    public function index(){
        ...
        $setting = $this->model->getOneByMap(['name' => $current_name]);
        if(request()->isPost()){
        ...
        switch ($current_name){
            case 'common':
                $builder->addFormItem('map_title', 'legend', '打印机', '打印机')
                    ->addFormItem('print_ip', 'text', '打印机ip', '打印机ip', [], 'required maxlength=60')
                    ->addFormItem('print_port', 'text', '打印机端口', '打印机端口', [], 'required maxlength=20');
                break;
            case 'weixin':
                $builder
