...
class Tpzsgather extends Botbase
{
    ...
    public function index()
    {
        if (request()->isPost()) {
            ...
            if ($total) {
                $list = $this->model->getListJoin(array_merge($params, [
                    ...
                    'field' => ['g.id','m.nickname as group_title', 'g.officer']
                ]));
            }else{
                $list = [];
            }
        ...
        $builder->addTopButton('addnew', ['title' => '添加采品群'])
            ...
            ->addTableColumn(['title' => '群聊', 'field' => 'group_title', 'minWidth' => 80])
            ->addTableColumn(['title' => '指挥官', 'field' => 'officer', 'minWidth' => 200])
