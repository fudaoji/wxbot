...
class Zdjrrule extends Botbase
{
    ...
    public function index(){
        ...
        $builder->addTopButton('addnew')
            ->setTip("同一时间只能执行一个任务")
            ->addTableColumn(['title' => '任务名称', 'field' => 'title', 'minWidth' => 100])
            ->addTableColumn(['title' => '执行机器人', 'field' => 'bots', 'minWidth' => 200])
            ->addTableColumn(['title' => '规则', 'field' => 'rules', 'minWidth' => 100])
            //->addTableColumn(['title' => '任务开始时间', 'field' => 'create_time', 'minWidth' => 120,'type' => 'datetime'])
    ...
    public function edit(){
        ...
        $builder->setPostUrl(url('savePost'))
            ...
            ->addFormItem('bots', 'chosen_multi', '执行机器人', '执行机器人', $bots)
