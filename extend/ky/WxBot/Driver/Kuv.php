...
class Kuv extends Base
{
    ...
    const EVENT_GROUP_MEMBER_ADD = '10014'; //群人员增加
    const EVENT_GROUP_MEMBER_DEC = '10013'; //群人员减少
    const EVENT_FRIEND_VERIFY = 'EventFriendVerify'; //好友请求事件
    const EVENT_DEVICE = "10022"; //设备回调事件
    const EVENT_LOGIN = "EventLogin"; //登录、退出
    const EVENT_LOGOUT = "EventLogout"; //退出
    const EVENT_GROUP_CHAT = "10019"; //群聊事件
    const EVENT_PRIVATE_CHAT = "10020"; //私聊消息事件
    const EVENT_SUBSCRIBE = "10021"; //公众号消息
