...
(function( root, factory ) {
     ...
     *
     * * module `base`：WebUploader.BaseBak
    ...
    define('base',[
        ...
        return {
             ...
             * 实现类与类之间的继承。
             * @method inherits
             * @grammar BaseBak.inherits( super ) => child
             * @grammar BaseBak.inherits( super, protos ) => child
             * @grammar BaseBak.inherits( super, protos, statics ) => child
             ...
             * };
             *
             * var Manager = BaseBak.inherits( Person, {
             *     world: function() {
             *         console.log( 'World' );
             *     }
             * });
             ...
             * @grammar BaseBak.bindFn( fn, context ) => Function
             * @method bindFn
             * @example
             ...
             *         name: 'Object Name'
             *     },
             *     aliasFn = BaseBak.bind( doSomething, obj );
             *
             *  aliasFn();    // => Object Name
             *
             */
            ...
            /**
             * 引用Console.log如果存在的话，否则引用一个[空函数loop](#WebUploader:BaseBak.log)。
             * @grammar BaseBak.log( args... ) => undefined
             * @method log
             */
            log: (function() {
                if ( window.console ) {
             ...
             * 将用来将非数组对象转化成数组对象。
             * @grammar BaseBak.slice( target, start[, end] ) => Array
             * @method slice
             * @example
             * function doSomthing() {
             *     var args = BaseBak.slice( arguments, 1 );
             *     console.log( args );
             * }
             *
             ...
             * 生成唯一的ID
             * @method guid
             * @grammar BaseBak.guid() => String
             * @grammar BaseBak.guid( prefx ) => String
             */
            guid: (function() {
                var counter = 0;
             ...
             * 格式化文件大小, 输出成带单位的字符串
             * @method formatSize
             * @grammar BaseBak.formatSize( size ) => String
             * @grammar BaseBak.formatSize( size, pointLength ) => String
             * @grammar BaseBak.formatSize( size, pointLength, units ) => String
             * @param {Number} size 文件大小
             * @param {Number} [pointLength=2] 精确到的小数点数。
             * @param {Array} [units=[ 'B', 'K', 'M', 'G', 'TB' ]] 单位数组。从字节，到千字节，一直往上指定。如果单位数组里面只指定了到了K(千字节)，同时文件大小大于M, 此方法的输出将还是显示成多少K.
             * @example
             * console.log( BaseBak.formatSize( 100 ) );    // => 100B
             * console.log( BaseBak.formatSize( 1024 ) );    // => 1.00K
             * console.log( BaseBak.formatSize( 1024, 0 ) );    // => 1K
             * console.log( BaseBak.formatSize( 1024 * 1024 ) );    // => 1.00M
             * console.log( BaseBak.formatSize( 1024 * 1024 * 1024 ) );    // => 1.00G
             * console.log( BaseBak.formatSize( 1024 * 1024 * 1024, 0, ['B', 'KB', 'MB'] ) );    // => 1024MB
             */
    ...
    define('uploader',[
         ...
         * @class Base
         * @static
         * @grammar BaseBak.create( opts ) => Uploader
         */
    ...
    define('runtime/html5/imagemeta/exif',[
        ...
        //         BaseBak.log('Invalid Exif data: Invalid thumbnail data.');
        //         return;
        //     }
        //     hexData = [];
        //     for (i = 0; i < length; i += 1) {
